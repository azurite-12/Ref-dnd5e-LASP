data_movement = [
    ...
    },
    {
        ...
        description: "Coste de movimiento: 10ft × 5ft escalados",
        reference: "PHB, pg. 182.",
        bullets: [
			"Puede involucrar una tirada de Atletismo si la escalada es difícil."
        ]
    },
    {
        title: "Nadar",
        icon: "at-sea",
        subtitle: "Coste: 10ft × 5ft",
        description: "Coste de movimiento: 10ft × 5ft nadados",
        reference: "PHB, pg. 182.",
        bullets: [
            "Puede involucrar una tirada de Atletismo si la nadada es difícil."
        ]
    },
    {
    ...
    },
    {
        title: "Levantarse",
        icon: "strong",
        subtitle: "Coste: Mitad de tu velocidad",
        description: "Coste de movimiento: La mitad de tu velocidad total",
        reference: "PHB, pg. 190-191.",
        bullets: [
            "No te puedes levantar si no te queda la suficiente velocidad, o si tu velocidad es 0."
        ]
    },
    {
        title: "Salto alto",
    ...
    },
    {
        ...
        bullets: [
            ...
            "Vease la acción de agarre en la sección de acciones para consultar detalles acerca de como agarrar una criatura."
        ]
    }
]
